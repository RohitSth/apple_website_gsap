...
const Model = () => {
  ...
  const [model, setModel] = useState({
    ...
    color: ["#8F9A91", "#FFE7B9", "#6F6C64"], // Different colors for different meshes
    img: yellowImg,
  });
  ...
  // keep track of rotation of the models
      ...
      <div className="screen-max-width">
        ...
        <div className="flex flex-col items-center mt-5">
          <div className="relative w-full h-[75vh] md:h-[90vh] overflow-hidden">
            ...
            >
              {/* View.Port is a way to render multiple views of a model the same canvas */}
              <View.Port />
            </Canvas>
          </div>
